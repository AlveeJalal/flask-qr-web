...
def index_get():
    ...
    form = '<h1>Make a QR code IS218</h1> <form method="POST" action="/"> \
               ...
               <input type="text" id="qrurl" name="qrurl" value="' + Config.QR_CODE_DEFAULT_URL + '"><br> \
            <label for="qr_file_name"> QR FILENAME:</label><br> \
              <input type="text" id="qr_file_name" name="qr_file_name" value="' + Config.QR_CODE_DEFAULT_FILE_NAME + '"><br> \
